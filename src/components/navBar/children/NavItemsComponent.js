    ...
    return (
        ...
        <React.Fragment>
            {is_nav_open ? 
                ...
                pointer width='95%' height="fit-content" padding="10px 0 10px 10px"  onClick={() => {dispatch(changeTab(ImgData.render))}}>
                    <Img src={ImgData.src} width="30px" height="30px" margin="0 0 4px 0"></Img>
                    <P fontSize="12px" margin="0 10px">{ImgData.name}</P>
                </NavDiv>
                :
                <NavDiv flexAttr="center=center=column" key={ImgData.id} 
                        pointer width='100%' height="74px" onClick={() => {dispatch(changeTab(ImgData.render))}}>
                        <Img src={ImgData.src} width="30px" height="30px" margin="0 0 4px 0"></Img>
                        <P fontSize="12px" margin="0 10px">{ImgData.name}</P>
                </NavDiv>
            }
